...
class App
  ...
  bloom :dig do
    ...
    temp :slope_sw <= areas {|a| [a.x - 1, a.y + 1, a.depth]}
    temp :slope_se <= areas {|a| [a.x + 1, a.y + 1, a.depth]}
    temp :slope_n <= areas {|a| [a.x, a.y - 1, a.depth]}
    temp :slope_nw <= areas {|a| [a.x - 1, a.y - 1, a.depth]}
    temp :slope_ne <= areas {|a| [a.x + 1, a.y - 1, a.depth]}
    temp :slope_w <= areas {|a| [a.x - 1, a.y, a.depth]}
    temp :slope_e <= areas {|a| [a.x + 1, a.y, a.depth]}
    areas <= (slope_s * slope_sw * slope_se * slope_n * slope_nw * slope_ne * slope_w * slope_e * areas).matches {|s,sw,se,n,nw,ne,w,e,a| [a.x, a.y, a.depth + 1]}
  end
